      ...
      <div className="card relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-sage-900 font-display">
            Sign in to Eco Sakshi
          </h2>
          <p className="text-sage-600 mt-2">
            Continue protecting India's environment
          </p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2">
              <input type="checkbox" className="w-4 h-4 rounded border-sage-300 text-forest-600 focus:ring-forest-500" />
              <span className="text-sm text-sage-600">Remember me</span>
            </label>
            <Link href="/forgot-password" className="text-sm text-forest-600 hover:text-forest-700 font-medium">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="my-6 flex items-center gap-4">
          ...
          <span className="text-sm text-sage-500">or continue with</span>
          <div className="flex-1 h-px bg-sage-200" />
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl border-2 border-sage-200 bg-white text-sage-800 font-semibold transition-all duration-300 hover:border-sage-300 hover:bg-sage-50 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-forest-500 focus:ring-offset-2 disabled:opacity-50"
        >
          {isGoogleLoading ? (
            <Loader2 className="w-5 h-5 animate-spin" />
          ) : (
        ...
        <p className="mt-6 text-center text-sm text-sage-600">
          ...
          <Link href="/register" className="text-forest-600 hover:text-forest-700 font-semibold">
            Create Account
          </Link>
        </p>
      </div>
